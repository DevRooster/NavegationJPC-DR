package com.example.navegationjpc_dr.ui.presentation.component
...
@Composable
fun AppBarActions(darkMode: MutableState<Boolean>, themeType: MutableState<ThemeType>, openDialog: () -> Unit) {
    ChangeMode(darkMode)
